...
namespace AdventOfCode.Year2019 {
    public class Day03 : Challenge {
        ...
        protected override string SolvePart1() => $"Nearest intersection is {FindClosestIntersection()} units from origin.";
        
        protected override string SolvePart2() => $"Shortest intersection is {FindShortestIntersection()} units along wires.";
