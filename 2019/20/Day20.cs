...
namespace AdventOfCode.Year2019 {
    public class Day20 : Challenge {
        ...
        protected override string SolvePart1() => $"Shortest path: {FindShortestPath()} steps";
        
        protected override string SolvePart2() => $"Shortest path: {FindShortestPathRecursive()} steps";
