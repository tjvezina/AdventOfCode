...
namespace AdventOfCode.Year2015 {
    public class Day05 : Challenge {
        ...
        protected override string SolvePart1() => $"Nice strings (rule set A): {_input.Count(IsNiceRuleSetA)}";
        
        protected override string SolvePart2() => $"Nice strings (rule set B): {_input.Count(IsNiceRuleSetB)}";
