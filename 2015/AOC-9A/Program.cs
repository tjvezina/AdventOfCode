...
public static class Program {
    ...
    private static int[] _shortestOrder;
    private static int _shortestDist = int.MaxValue;
    ...
    private static void Main(string[] args) {
        ...
        Console.WriteLine(_shortestDist);
    }
    ...
    private static void Initialize() {
        ...
        _shortestOrder = new int[_cities.Count];
    ...
    private static void FindShortestOrder() {
        do {
            CheckOrderDist();
